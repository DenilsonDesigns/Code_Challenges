...
const findIdFromStr = (targetStr, strSplitter) => {
  let curr = targetStr.split(strSplitter[0]);
  return curr[1] ? curr[1].split(strSplitter[1])[0] : "";
};

console.log(
  findIdFromStr(
    '<ul class="navbar-nav ml-auto"><li class="dropdown"><a id="Dropdown-617f5d6f77e9f" class="btn btn-default dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>Tools<span class="caret"></span></a><div class="dropdown-menu dropdown-menu-right dropDownToggleFix" aria-labelledby="Dropdown-617f5d6f77e9f"></div></li></ul>',
    ["{&quot;id&quot;:", "}"]
  )
);
